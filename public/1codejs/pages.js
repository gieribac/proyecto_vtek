const 
    ...
    <div id="menu"></div>
      ...
      ` ,
    admin_infoclients = `         <div class="d-flex align-items-stretch flex-column">
    <div id="menu"></div>
      <div class="row-cols-lg-4 col-md-4 col-sm-6 col-xs-12">
          <div class="infopagina">
    ...
    <div id="menu"></div>
        ...
        <div class="cols-lg-4  col--6 col-xs-12   margenusu">
            ...
            <i class="formulario"></i>
              ...
              <div class="avisopSave"></div>
                <button type="submit" class="btn btnguardar btnsave2 " id="guardarCF"> <h6 class="letrabtng ">Guardar</h6></button>
            </div>
        </fieldset>
      </form>
    </div>`,
