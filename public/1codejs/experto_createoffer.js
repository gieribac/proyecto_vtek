                    ...
                    l_id = [];
                        ...
                        ds.forEach(d => {
                            ...
                            if (d.data().evaluado) {
                                ...
                                formalizar.innerHTML += `<span><button id="${d.id}" name="${d.data().No_oferta}" type="button" class="btn btn_degrade" style="margin-bottom: 9px; margin-top: 5px; margin-right: 10px;"></button>evaluar</span>`;
                            }
